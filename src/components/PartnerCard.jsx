...
const icons = { Building2, LineChart, HardHat, Briefcase, Store, Network }

export default function PartnerCard({ title, description, icon }) {
  ...
  return (
    <article className="rounded-3xl border border-border bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:border-sage hover:shadow-card">
      ...
      <h3 className="font-display text-base font-bold tracking-wide text-charcoal">
        {title}
      </h3>
